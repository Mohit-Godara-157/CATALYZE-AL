...
const NavBar = () => {
  ...
  return (
    <div>
      <>
        <div className="py-4 navBg z_2 ">
          <div className="positionGreenBox position-absolute animatoinXmove top-0 start-0"></div>
          <div className="positionskyBox position-absolute animatoinXmove top-0 start_20"></div>
          <Container className="customContainer">
            <nav className="d-flex align-items-center justify-content-between">
              <div className="d-flex align-items-center">
                ...
                <a
                  className="d-flex d-none d-lg-block NavLinks position-relative align-items-center  text-black ms-5 fw-semibold fs_sm"
                  href="#"
                >
              ...
              >
                ...
                <a
                  onClick={() => setNav(false)}
                  className="d-flex my-3 my-lg-0  d-lg-none NavLinks position-relative align-items-center  text-black  fw-semibold fs_sm"
                  href="#"
                >
                  <img src={financial} alt="financial" />
                  <span className="ps-2"> Financial Services</span>
                ...
                <li onClick={() => setNav(false)} className=" my-3 my-lg-0">
                  <a className="fw-semibold fs_sm text_green navBtn" href="#">
                    Sign up
                  </a>
                </li>
                <li
                ...
                >
                  <a className="fw-semibold fs_sm text_green logBtn" href="#">
                    Log in
                    <svg
                      className="ps-2"
                      width="24"
