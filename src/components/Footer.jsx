...
const Footer = () => {
  ...
  return (
    <div className="footerBgDark z_2 position-relative overflow-hidden mt-4">
      <a
        className={
          first
      ...
      >
        <a href="#">
          <img src={upBtn} alt="up_arrow" />
        </a>
      </a>
      <div className="positionbluebox position-absolute animatoinOpacity end_10 top_40 top_xl_0"></div>
        ...
        <Row className="py-4 py-lg-5">
            ...
            <Row className="align-items-center">
              <Col className="my-3 my-lg-0" md={7}>
                <input
                  type="text"
                  placeholder="Name"
                  className="inputModify fs_sm text_white_40  fw-semibold"
                />
                <input
                  type="text"
                  placeholder="Email"
                  className="inputModify fs_sm text_white_40 my-2 fw-semibold"
                />
                <div className="d-flex align-items-center justify-content-between">
                  <button className="d-flex align-items-center  fw-semibold fs_sm text_green_50 footerBtn">
                    <div className="btnCircle1 me-2"></div> Financial Services
                  </button>
                  <button className="d-flex align-items-center  fw-semibold fs_sm text_white_50 stateBtn">
              ...
              <Col className="my-3 my-lg-0" md={5}>
                <textarea
                  className="inputModify text_white_40 fs_sm fw-semibold"
                  cols="30"
                  rows="3"
                  placeholder="Message.."
                ></textarea>
                <button className="submitBtn mt-2 text-white fw-semibold fs_sm">
                  Submit
                </button>
              </Col>
            </Row>
          ...
          <Col className="my-3 my-xl-0 " xl={5}>
            <div className="ps-xl-5 ">
              <h3 className="text-white fw-semibold mb-0 fs_lg">Contact us</h3>
      ...
      <Container className="customContainer">
        <Row className="py-4 py-lg-5">
          <Col className="my-3 my-lg-0" lg={4}>
            ...
            <div className=" mt-2 ">
              <a
                className="text-white fs_sm fw-semibold"
          ...
          <Col className="my-3 my-lg-0" lg={8}>
            <Row>
              <Col className="my-3 my-sm-0" xs={6} sm={4}>
                <ul className="ps-0 ">
                  <li className="text-white fs_sm fw-semibold">
                    Financial Services
                  </li>
                  <li className="mt-3">
                    <a
                      className="position-relative footerLinks text-white fs_sm fw-normal"
                      href="#"
                    >
                      Pricing
                    </a>
              ...
              <Col className="my-3 my-sm-0" xs={6} sm={4}>
                <ul className="ps-0 ">
                  <li className="text-white fs_sm fw-semibold">Real Estate</li>
                  <li className="mt-3">
                    <a
                      className="position-relative footerLinks text-white fs_sm fw-normal"
                      href="#"
              ...
              <Col className="my-3 my-sm-0" xs={6} sm={4}>
                <ul className="ps-0 ">
                  <li className="text-white fs_sm fw-semibold">LinkedIn</li>
                </ul>
              </Col>
            </Row>
          </Col>
        </Row>
        <div className="pb-4 d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between">
          <div className="d-sm-flex mb-lg-3">
